...
import pytest
from network_manager import NetworkConfigManager
...
def test_show_host_name(network_config_manager):
    ...
    assert network_config_manager.show_hostname() == "hostname: 1"
...
def test_update_hostname(network_config_manager):
    ...
    assert network_config_manager.show_hostname() == "hostname: new_hostname"
